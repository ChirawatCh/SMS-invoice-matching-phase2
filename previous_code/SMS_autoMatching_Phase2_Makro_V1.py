...
df_B2B_diffrNett = df_merge[(df_merge['Total_Amt_difference'].notnull()) & (df_merge['Total_Amt_difference'] != 0) & (df_merge['null_report'] == '')]
df_B2B_diffrTax = df_merge[(df_merge['Tax_difference'].notnull()) & (df_merge['Tax_difference'] != 0) & (df_merge['null_report'] == '')]
