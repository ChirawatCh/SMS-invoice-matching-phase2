...
df_Base = df_Base.rename(columns={'จำนวนเงิน\n(ก่อนVAT)': 'Exc_Vat'})
...
## Write the reconciled data_v1 and the counts to a single Excel file ##
with pd.ExcelWriter("outputs/reconciled_data_PerfectCompanion.xlsx") as writer:
...
df_CPFM_diff_select.to_csv('outputs/cpfm_b2b_diff_PerfectCompanion.csv', index=False)
